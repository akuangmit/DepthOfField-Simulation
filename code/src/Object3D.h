...
{
public:
    // default contstructor: cone with base at origin and radius 1, pointing straight up
    Cone() {
        _center = Vector3f(0.0, 0.0, 0.0);
        _radius = 1.0f;
        _axis = Vector3f(0.0,0.0,1.0);
        _height = 1.0f;
    }
...
{
public:
    Transform(const Matrix4f &m, Object3D *obj) : _m(m), _object(obj)
    {
    }
